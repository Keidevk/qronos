...
export default function CompanyScreen() {
    ...
    const updateEmpresaData = async () => {
        ...
        try {
            ...
            data.append('categoria', formData.categoria); // Categoría validada por los botones

            // Función auxiliar para imágenes
            const appendImage = (key: string, uri: string | null) => {
                if (!uri) return;
                // Si la imagen ya es una URL remota (no cambió), no la enviamos o la manejamos según backend
...
const styles = StyleSheet.create({
    ...
    infoBoxIndex: {
        flexDirection: 'row',
        backgroundColor: 'rgba(1, 195, 142, 0.1)', // Fondo verdoso suave
        padding: 15,
        borderRadius: 12,
        marginBottom: 25,
        alignItems: 'center',
    ...
    categoryChipTextActive: {
        color: '#000', // Texto negro sobre el verde
        fontFamily: FONTS.textBold
    },
    rowInputs: {
        flexDirection: 'row',
